...
list_ble = {"name": [], "addr": []}
message = None
# uuid_list= {"Hrate_Service": {"uuid": "0000180d-0000-1000-8000-00805f9b34fb", "Characteristic": {"Hrate_Characteristics": "00002a37-0000-1000-8000-00805f9b34fb", "Description":"00002a38-0000-1000-8000-00805f9b34fb"}},
#             "Nordic_UART_Service": {"uuid": "bbb40a00-337f-4081-9a0b-10d0f09716d3", "Characteristic": {"Nordic_UART_RX": "bbb40b00-337f-4081-9a0b-10d0f09716d3"}}}
#
# uuid_list= {"Service_uuid":{"Characteristic_uuid"}}
uuid_list= {"Service_uuid":{"Characteristic_uuid"}}
    ...
    def services_resolved(self):
        ...
        for service in self.services:
            ...
            for characteristic in service.characteristics:
                ...
                uuid_list[str(service.uuid)][str(characteristic.uuid)]={}
                try:
...
class MainWindow:
    ...
    def insert_data(self):
        ...
        if flag_value_change:
            ...
            try:
                result = message
                temperature = result[4:6]
                heart_rate = result[8:10]
